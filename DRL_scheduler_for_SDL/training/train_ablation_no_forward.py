"""
FSS training -- ablation: no forward Tmax mask + no forward Tmax reward.

train.py with the adapter swapped for AblationAdapterNoForward and an isolated
...
from ablation_components import AblationAdapterNoForward
...
class FSSTrainer:
    ...
    def __init__(self, env_config_path, ppo_config=None):
        ...
        self.adapter = AblationAdapterNoForward(self.env, ppo_config)
    ...
    def train(self, num_episodes=1000, save_interval=1):
        ...
        for episode in range(num_episodes):
            ...
            if (episode + 1) % save_interval == 0:
                save_dir = os.path.join(project_root, 'saved_models_ablation_no_forward')
